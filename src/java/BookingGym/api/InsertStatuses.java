...
@WebServlet(name = "InsertStatuses", urlPatterns = {"/InsertStatuses"})
public class InsertStatuses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
          Statuses statuses = JsonStatusesMapper.fromJson(jsonObject);
           ...
           int res=statusesController.insertStatuses(statuses);
           out.print(res);
        }
    }
