...
@WebServlet(name = "GetAllStatuses", urlPatterns = {"/GetAllStatuses"})
public class GetAllStatuses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            List<Statuses> statuses =  statusesController.getAllStatuses();
