...
@WebServlet(name = "InsertClients", urlPatterns = {"/InsertClients"})
public class InsertClients extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            Clients client = JsonClientsMapper.fromJSON(json);
            ClientsController clientController = new ClientsController();
            int count = clientController.insertClients(client);
            out.print(count);
        }
    }
