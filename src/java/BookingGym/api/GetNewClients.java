 ...
 * @author Alex
 */
@WebServlet(name = "GetNewClients", urlPatterns = {"/GetNewClients"})
public class GetNewClients extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) 
        {
            ...
            List<Clients> clients =  clientsController.getNewClients();
